...
function AdminMobileDrawer({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 lg:hidden">
      ...
      <aside className="absolute inset-y-0 right-0 flex w-[min(100vw-4rem,20rem)] flex-col border-l border-white/55 bg-surface-container-lowest/95 shadow-[0_12px_40px_rgba(74,48,32,0.12)] backdrop-blur-[28px]">
