...
function AdminMobileBottomNav({ onOpenMenu }) {
  ...
  return (
    <nav
      className="fixed inset-x-0 bottom-0 z-40 border-t border-white/55 bg-surface-container-lowest/95 pb-[env(safe-area-inset-bottom)] backdrop-blur-xl lg:hidden"
